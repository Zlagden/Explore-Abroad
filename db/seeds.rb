...
Country.create!([
  ...
  information: {
    ...
    Highlights: [
      { title: "Public Transport", description: "Japan’s public transportation system is globally recognised for its punctuality, cleanliness, and efficiency. The country’s extensive rail network, including local trains, subways, and the world-famous Shinkansen (bullet train), connects urban centres and rural areas with remarkable speed and reliability.", image_url: "https://images.unsplash.com/photo-1607612340136-530f60e45c27?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTh8fGphcGFuJTIwcHVibGljJTIwdHJhbnNwb3J0JTIwY29vbHxlbnwwfHwwfHx8MA%3D%3D" },
